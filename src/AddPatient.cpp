...
pof::AddPatient::AddPatient( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer2->Add( TitleText, 0, wxALL, FromDIP(5) );
	...
	bSizer2->Add( m_staticText18, 0, wxALL, FromDIP(5) );
	...
	mPatientName->Wrap( -1 );
	fgSizer2->Add( mPatientName, 0, wxALIGN_CENTER_VERTICAL|wxALL, FromDIP(5) );
	...
	fgSizer2->Add( mPatientNameValue, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, FromDIP(5) );
	...
	fgSizer2->Add( mPatientLastName, 0, wxALL, FromDIP(5) );
	...
	fgSizer2->Add( mPatientLastNameValue, 1, wxALL|wxEXPAND, FromDIP(5) );
	
	mDateOfBirth = new wxStaticText( m_scrolledWindow2, wxID_ANY, wxT("Date of birth"), wxDefaultPosition, wxDefaultSize, 0 );
	mDateOfBirth->Wrap( -1 );
	fgSizer2->Add( mDateOfBirth, 0, wxALIGN_CENTER_VERTICAL|wxALL, FromDIP(5) );
	...
	mGenderLabel->Wrap(-1);
	fgSizer2->Add(mGenderLabel, 0, wxALIGN_CENTER_VERTICAL | wxALL, FromDIP(5));
	...
	fgSizer2->Add( mGenderValue, 0, wxALL|wxEXPAND, FromDIP(5) );


	mPhonenumber = new wxStaticText( m_scrolledWindow2, wxID_ANY, wxT("Phone number"), wxDefaultPosition, wxDefaultSize, 0 );
	mPhonenumber->Wrap( -1 );
	fgSizer2->Add( mPhonenumber, 0, wxALIGN_CENTER_VERTICAL|wxALL, FromDIP(5) );
	...
	fgSizer2->Add( mPhonenumberValue, 0, wxALL|wxEXPAND, FromDIP(5) );
	...
	bSizer1->Add( m_panel2, 1, wxEXPAND | wxALL, FromDIP(5) );
	...
	bSizer4->Add( m_sdbSizer2, 1, wxEXPAND, FromDIP(15) );
	
	
	m_panel7->SetSizer( bSizer4 );
	m_panel7->Layout();
	bSizer4->Fit( m_panel7 );
	bSizer1->Add( m_panel7, 0, wxEXPAND | wxALL, FromDIP(5) );
...
bool pof::AddPatient::TransferDataFromWindow()
{
	...
	v[pof::PatientManager::PATIENT_AGE] = date.Format("%d/%m/%Y").ToStdString();
